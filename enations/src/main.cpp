...
void CWndMain::Create() {
    ...
    if ( CreateEx( dwExSty, theApp.m_sClsName, theApp.m_sAppName, dwSty, 0, 0, GetSystemMetrics( SM_CXSCREEN ), GetSystemMetrics( SM_CYSCREEN ), NULL, NULL, NULL ) == 0 )
