...
public:
    ...
    enum BLDG_TYPE {
        city,        // this is returned by GetType ()
        rocket,
    ...
    enum BLDG_DLG_GRP {
        dlg_no_show,  // for the build building dialog - building groups
        dlg_const_yards,
        dlg_natural_res,
        dlg_forts,
        dlg_manuf,
    ...
    enum BLDG_UNION_TYPE {
        UTmaterials,  // builds materials - m_iUnionType values GetUnionType ()
    ...
    enum BLDG_FLAGS {
        FlVehExit = 0x01, FlShipExit = 0x02, FlPartWater = 0x04, FlBlackHole = 0x08,
...
protected:
    ...
    int   m_aiBuild[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_BUILD_TYPES )]; // materials needed to build
...
protected:
    ...
    int   m_aiInput[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_TYPES )]; // materials needed for input
    int   m_aiOutput[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_TYPES )]; // materials created from input
...
protected:
    ...
    int   m_iTime;        // time to build
    int   m_aiInput[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_TYPES )]; // materials needed to build
...
protected:
    ...
    int   m_aiTotalInput[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_BUILD_TYPES )]; // materials needed to build 1 of each
...
protected:
    ...
    int   m_aiTotalRepair[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_BUILD_TYPES )]; // materials needed to fully repair 1 of each
...
protected:
    ...
    LONG     m_aiRepair[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_BUILD_TYPES )]; // points toward repairing
...
protected:
    ...
    LONG        m_aiUsed[static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>( CMaterialTypes::TYPE::NUM_BUILD_TYPES )]; // materials used for this vehicle
...
public:
    ...
    CShipyardBuilding( int iBldg, int iBldgDir, int iOwner = 0, DWORD ID = 0 ):
        CVehicleBuilding( iBldg, iBldgDir, iOwner, ID ) {
        ctor();
    }
    ~CShipyardBuilding();
