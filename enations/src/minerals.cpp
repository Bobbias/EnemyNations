...
CMinerals::CMinerals( CMaterialTypes::TYPE iType, int iDensity, int iQuantity ) {
...
CArchive& operator<< ( CArchive& ar, const CMinerals& mn ) {
    ...
    ar << mn.m_lQuantity << static_cast<std::underlying_type_t<CMaterialTypes::TYPE>>(mn.m_cType) << mn.m_cDensity;
    return ( ar );
}
