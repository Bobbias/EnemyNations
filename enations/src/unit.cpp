...
BOOL CVehicle::GetDrawParms( CQuadDrawParms& drawparms, CBridgeUnit const* pbridge ) const {
    ...
    auto zeros = CPoint( 0, 0 ); // NOTE: instantiated the point here rather than directly inline below.
    drawparms = CQuadDrawParms( (CVehicle&)*this, zeros, ptCenter, byRotAngle );
