...
inline int CVehicle::GetProd( float fProd ) {
    div_t dtProd = div( (int)( m_fDamPerfMult * fProd * theGame.GetOpersElapsed() ) + (int)m_lOperMod, AVG_SPEED_MUL ); // NOTE: added int cast to m_lOperMod to disambiguate. This narrows m_lOperMod from long to int!
