...
//---------------------------------------------------------------------------
LONG FAR PASCAL
CGlobalSubClassDialog::WindowProc( HWND hWnd, UINT Message, WPARAM wParam, LPARAM lParam ) {
...
//---------------------------------------------------------------------------
LONG FAR PASCAL
CGlobalSubClassButton::WindowProc(HWND hWnd, UINT Message, WPARAM wParam, LPARAM lParam ) {
   ...
   [[fallthrough]];
    ...
    if ( BS_GROUPBOX == dwStyle )
        ...
        case WM_GETTEXT:
        {
            ...
            int  nMaxChars = wParam;
            auto psz = reinterpret_cast<char*>(lParam);
