...
// CDIB::Clear
//-------------------------------------------------------------------------
void CDIB::Clear( CRect const* prect, /* NULL means the entire window*/ int iPaletteIndex )  // Global palette index of desired color
{
    ASSERT_STRICT_VALID( this );
...
//-------------------------------------------------------------------------
void CDIB::SetBits( BYTE const* pbyBits, CRect const* prectDst ) {
    ASSERT_STRICT_VALID( this );
...
// CDIB::SetBits
//--------------------------------------------------------------------------
void CDIB::SetBits( BITMAPINFOHEADER* pBih, void const* pvBits ) {
    ASSERT_STRICT_VALID( this );
...
//--------------------------------------------------------------------------
void CDIB::SetBits24( BITMAPINFOHEADER* pBih, void const* pvBits ) {
...
//-------------------------------------------------------------------------
BOOL CDIB::BitBlt( CDIB* pdibDst, CRect const& rectDst, CPoint const& ptSrc ) {
    ASSERT_STRICT_VALID( this );
...
//---------------------------------------------------------------------------
BOOL CDIB::StretchBlt( CDIB* pdibDst, CRect const& rectDst, CRect const& rectSrc ) {
    ASSERT_STRICT_VALID( this );
    ASSERT_STRICT( GetBitsPerPixel() == pdibDst->GetBitsPerPixel() );
...
//---------------------------------------------------------------------------
BOOL CDIB::StretchTranBlt( CDIB* pdibDst, CRect const& rectDst, CRect const& rectSrc, int iTransColor ) // Palette index
{
    ASSERT_STRICT_VALID( this );
    ASSERT_STRICT( GetBitsPerPixel() == pdibDst->GetBitsPerPixel() );
...
//-------------------------------------------------------------------------
BOOL CDIB::TranBlt( CDIB* pdibDst, CRect const& rectDst, CPoint const& ptSrc, int iTransColor ) {
    ASSERT_STRICT_VALID( this );
    ASSERT_STRICT_VALID( pdibDst );
...
// CDIB::ReleaseDC
//-------------------------------------------------------------------------
void CDIB::ReleaseDC( BOOL bSaveChanges ) {
    ASSERT( 1 == m_iLock );
    ASSERT( m_bBitmapSelected );
...
// CDIB::IsInRange
//-------------------------------------------------------------------------
BOOL CDIB::IsInRange( BYTE const* pby, int iBytes ) const {
    ASSERT_STRICT_VALID( this );
...
//-------------------------------------------------------------------------
void CDIB::Copy( LPBITMAPINFO lpBmi, void const* pvBits ) {
    ASSERT( !IsLocked() );
...
// CDIB::Copy            BobP - 4/30/96
//-------------------------------------------------------------------------
void CDIB::Copy( CBitmap const& bmp ) {
    ASSERT_STRICT_VALID( this );
