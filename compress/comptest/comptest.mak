...
!MESSAGE 
!MESSAGE NMAKE /f "COMPTEST.MAK" CFG="comptest - Win32 Debug"
!MESSAGE 
...
ALL : "$(OUTDIR)\COMPTEST.exe"

CLEAN : 
	-@erase ".\Release\COMPTEST.exe"
...
# ADD CPP /nologo /G5 /MD /W4 /GX /O2 /Ob2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_AFXDLL" /D "_MBCS" /YX /c
CPP_PROJ=/nologo /G5 /MD /W4 /GX /O2 /Ob2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /D "_AFXDLL" /D "_MBCS" /Fp"$(INTDIR)/COMPTEST.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/COMPTEST.bsc" 
BSC32_SBRS=
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 wind40.lib winmm.lib setargv.obj /nologo /subsystem:console /machine:I386
# SUBTRACT LINK32 /nodefaultlib
LINK32_FLAGS=wind40.lib winmm.lib setargv.obj /nologo /subsystem:console\
 /incremental:no /pdb:"$(OUTDIR)/COMPTEST.pdb" /machine:I386\
 /out:"$(OUTDIR)/COMPTEST.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Stdafx.obj" \
	"$(INTDIR)/main.obj"

"$(OUTDIR)\COMPTEST.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase ".\Debug\COMPTEST.exe"
	-@erase ".\Debug\main.obj"
	-@erase ".\Debug\Stdafx.obj"
	-@erase ".\Debug\COMPTEST.ilk"
	-@erase ".\Debug\COMPTEST.pdb"
...
CPP_PROJ=/nologo /G5 /MDd /W4 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D\
 "_CONSOLE" /D "_AFXDLL" /D "_MBCS" /Fp"$(INTDIR)/COMPTEST.pch" /YX\
...
LINK32_FLAGS=wind40d.lib winmm.lib setargv.obj /nologo /subsystem:console\
 /incremental:yes /pdb:"$(OUTDIR)/COMPTEST.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/COMPTEST.exe" 
LINK32_OBJS= \
	"$(INTDIR)/main.obj" \
	"$(INTDIR)/Stdafx.obj"
