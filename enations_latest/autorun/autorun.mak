...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/AUTORUN.res" /d "NDEBUG" 
BSC32=bscmake.exe
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/AUTORUN.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/AUTORUN.bsc" 
...
"$(INTDIR)\AUTORUN.res" : $(SOURCE) $(DEP_RSC_AUTOR) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
...
"$(INTDIR)\AUTORUN.OBJ" : $(SOURCE) "$(INTDIR)"
