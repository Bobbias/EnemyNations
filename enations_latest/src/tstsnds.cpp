...
CDlgTestSounds::CDlgTestSounds( CWnd* pParent /*=NULL*/ ): CDialog( CDlgTestSounds::IDD, pParent )
{
...
BOOL CDlgTestSounds::OnInitDialog( )
{
    ...
    if ( ( theMusicPlayer.GetMode( ) == CMusicPlayer::MUSIC_MODE::midi_only ) ||
         ( theMusicPlayer.GetMusicVolume( ) == 0 ) )
