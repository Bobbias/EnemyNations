...
inline int CStructure::GetNumBuildings( ) const
{
    return ( m_iNumBuildings );
}
inline int CStructureData::GetPopHoused( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iMaxMaterials );
}

//   CBuildMaterials
inline int CBuildMaterials::GetTime( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iTime );
}
inline int CBuildMaterials::GetInput( int iInd ) const
{
    ASSERT_STRICT( ( 0 <= iInd ) && ( iInd < CMaterialTypes::num_types ) );
    ASSERT_STRICT_VALID( this );
    return ( m_aiInput[iInd] );
}
inline int CBuildMaterials::GetOutput( int iInd ) const
{
    ASSERT_STRICT( ( 0 <= iInd ) && ( iInd < CMaterialTypes::num_types ) );
    ASSERT_STRICT_VALID( this );
    return ( m_aiOutput[iInd] );
}

//   CBuildUnit
inline int CBuildUnit::GetTime( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iTime );
}
...
//   CBuildVehicle
inline int CBuildVehicle::GetSize( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_aBldUnits.GetSize( ) );
}
inline int CBuildVehicle::GetTotalInput( int iInd ) const
{
    ASSERT_STRICT( ( 0 <= iInd ) && ( iInd < CMaterialTypes::num_build_types ) );
    ASSERT_STRICT_VALID( this );
    return ( m_aiTotalInput[iInd] );
}
inline CBuildUnit const* CBuildVehicle::GetUnit( int iInd ) const
{
    ASSERT_STRICT_VALID( this );
...
//   CBuildRepair
inline int CBuildRepair::GetTotalRepair( int iInd ) const
{
    ASSERT_STRICT( ( 0 <= iInd ) && ( iInd < CMaterialTypes::num_build_types ) );
    ASSERT_STRICT_VALID( this );
    return ( m_aiTotalRepair[iInd] );
}
inline CBuildUnit const* CBuildRepair::GetRepair( int iInd ) const
{
    ASSERT_STRICT_VALID( this );
    ASSERT_STRICT( ( 0 <= iInd ) && ( iInd < m_aBldUnits.GetSize( ) ) );
...
//   CStructureData
inline CStructureData::BLDG_TYPE CStructureData::GetType( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iType );
}
inline CStructureData::BLDG_UNION_TYPE CStructureData::GetUnionType( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iUnionType );
}
inline int CStructureData::GetCat( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iBldgCat );
}
inline int CStructureData::GetTimeBuild( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iTimeBuild );
}
inline int CStructureData::GetMoraleEffect( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iMoraleEffect );
}
inline int CStructureData::GetBuild( int iInd ) const
{
    ASSERT_STRICT( ( 0 <= iInd ) && ( iInd < CMaterialTypes::num_build_types ) );
    ASSERT_STRICT_VALID( this );
    return ( m_aiBuild[iInd] );
}
inline int CStructureData::GetPower( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iPower );
}
inline float CStructureData::GetNoPower( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_fNoPower );
}
...
{
    float fInc = GetOwner( )->GetPplMult( ) * fProd / AVG_SPEED_MUL;
    if ( GetOwner( )->GetPwrMult( ) < 1 )
        fInc *= GetData( )->GetNoPower( ) + ( 1.0f - GetData( )->GetNoPower( ) ) * GetOwner( )->GetPwrMult( );
    float fRtn = fInc * theGame.GetOpersElapsed( ) + m_fOperMod;
    int   iRtn = (int)fRtn;
...
inline CHexCoord& CBuilding::GetHex( )
{
    ASSERT_STRICT_VALID( this );
    return ( m_hex );
}
inline CHexCoord const& CBuilding::GetHex( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_hex );
}
inline BOOL CBuilding::IsConstructing( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( (BOOL)( m_iConstDone != -1 ) );
}
inline CStructureData const* CBuilding::GetData( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( (CStructureData const*)m_pUnitData );
}
inline int CBuilding::NeedToBuild( int iInd, int iNum ) const
{
    ASSERT_STRICT_VALID( this );
...
{
    ASSERT_STRICT_VALID( this );
    int iMax = ( GetData( )->GetTimeBuild( ) * ( GetData( )->GetDamagePoints( ) - m_iDamagePoints ) ) /
               ( 2 * GetData( )->GetDamagePoints( ) );
    iPts = __min( iPts, iMax );
    return ( ( GetData( )->GetBuild( iInd ) * iPts ) / GetData( )->GetTimeBuild( ) );
}
inline int CBuilding::PointsRepaired( int iInd, int iMat ) const
{
    return ( ( iMat * GetData( )->GetTimeBuild( ) ) / GetData( )->GetBuild( iInd ) );
}

inline int CBuilding::GetPerHave( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_iMatTo );
}
...
//   CVehicleBuilding
inline CBuildUnit const* CVehicleBuilding::GetBldUnt( ) const
{
    ASSERT_STRICT_VALID( this );
    return ( m_pBldUnt );
}
...
inline CBuilding* CBuildingHex::GetBuilding( int x, int y ) const
{
    ...
    y = CHexCoord::Wrap( y );
    CBuilding* pBldg;
    if ( Lookup( ToArg( x, y ), pBldg ) )
        return ( pBldg );
    return ( NULL );
}
inline DWORD CBuildingHex::ToArg( int x, int y ) const
{
...
{
    CBuilding* pBldg;
    if ( Lookup( _ToArg( x, y ), pBldg ) )
        return ( pBldg );
    return ( NULL );
}
inline DWORD CBuildingHex::_ToArg( int x, int y ) const
{
