...
CDlgJoinPublish::CDlgJoinPublish( CWnd* pParent /*=NULL*/ ): CDialog( CDlgJoinPublish::IDD, pParent )
{
...
CDlgJoinGame::CDlgJoinGame( CWnd* pParent /*=NULL*/ ): CDialog( CDlgJoinGame::IDD, pParent )
{
...
StartOver:
    ...
    else if ( m_pJm->m_dlgPickRace.m_hWnd != NULL )
