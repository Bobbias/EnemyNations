...
extern "C++" // FIXME: Is this necessary?
{
#endif /* __BORLANDC__ */
...
#endif // _CRTIMP
#ifdef _MSC_VER
//_CRTIMP _PNH MEM_ENTRY_ANSI _set_new_handler(_PNH); // original
//_CRTIMP2 new_handler __cdecl _set_new_handler( _In_opt_ _PNH ) throw(); // based off new.h
#if UINT_MAX == 0xFFFFu
_PNH MEM_ENTRY_ANSI _set_fnew_handler(_PNH);
_PNHH MEM_ENTRY_ANSI _set_hnew_handler(_PNHH);
#endif // UINT_MAX
#endif // _MSC_VER
//typedef void (MEM_ENTRY_ANSI * pnh)(); // FIXME: Is this necessary?
//_CRTIMP pnh MEM_ENTRY_ANSI set_new_handler(pnh) MEM_CPP_THROW; // FIXME: Is this necessary?
